...
class UI {
private:
  Component createRootComp(Component &, Component &, Component &,
                           Component &); // creates the root component of the ui
  Component createCurrentDirComp(
      const path *); // creates a component to display current directory
  Component
  createCurrentFilesComp(const vector<string> *,
                         int *); // creates the file component which displays
                                 // all the files in current directory
  Component createSelectedFileComp(
      const string *); // creates the display component which displays the
                       // content or files in selected file
  Component createCliComp(
      string *, string *,
      string *); // creates the cli Component in which user can input cmds
  Component
  ...
  Component currentFilesComp; // component to display all the files in current
                              // directory
